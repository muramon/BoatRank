...
class BackTest():
    ...
    def backtest(self, test_ds=None, model=None, odds_json=None, model_type='RankNet', test_file = 'dataset/Toda_191201-191231.txt', kaijo=None, three=False):
        ...
        if three:
            ...
            csv_file = "./sanrenpuku_thresh_test/long_backtest_{}_model{}_{}.csv".format(model_type, model_name, test_file[8:-4])
        ...
        if three:
            ...
            fall = open('./sanrenpuku_thresh_test/{}_long_all_backtest.csv'.format(model_type), 'a')
        ...
        for qid, batch_rankings, labels in test_ds:
            ...
            try:
                ...
                for i in range(40):
                    win[i] = 0
                    if int(odds[9][1]) >= (100 * (i + 1)) and int(odds[9][1]) < (100 * (i + 2)):
                        win[i] = -100
                        count[i] += 1
